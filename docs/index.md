...
=== "CONTENU DE SÉANCE"
    ...
    > Si nécessaire, **créer** un compte élève sur [Capytale](https://capytale2.ac-paris.fr/web/c-auth/login){target=_blank} en vous connectant sans ENT avec le code Sésame `ZMKEVGAPG` ;
